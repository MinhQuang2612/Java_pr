...
public class QuanAo_Form extends JPanel {
    ...
    public void doShow(){
        ...
        JLabel lblTieuDe = new JLabel("Quần Áo");
        ...
        SanPham_DAO lkDao = new SanPham_DAO();
        SanPham sp1,sp2,sp3,sp4,sp5;
        List<SanPham> ls = lkDao.TimKiemLoai("LSP001");
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/images_SanPham/dirtycoins1.png"));
//        lbImages1.setPreferredSize(new Dimension(110,110));
        ...
        icon2 = new ImageIcon(getClass().getResource("/images_SanPham/dirtycoins2.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon3 = new ImageIcon(getClass().getResource("/images_SanPham/dirtycoins3.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon4 = new ImageIcon(getClass().getResource("/images_SanPham/hades1.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
...
//                pnN11.setVisible(false);
        ...
        ImageIcon icon5 = new ImageIcon(getClass().getResource("/images_SanPham/hades2.png"));
//        lbImages1.setPreferredSize(new Dimension(110,110));
        ...
        icon6 = new ImageIcon(getClass().getResource("/images_SanPham/hades3.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon7 = new ImageIcon(getClass().getResource("/images_SanPham/odin1.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon8 = new ImageIcon(getClass().getResource("/images_SanPham/odin1.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
