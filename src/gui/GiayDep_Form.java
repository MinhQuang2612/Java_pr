...
public class GiayDep_Form extends JPanel {
    ...
    public void doShow(){
        ...
        JLabel lblTieuDe = new JLabel("Giày Dép");
        ...
        List<SanPham> ls = spDao.TimKiemLoai("LSP002");
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/images_SanPham/DSMH062001.png"));
//        lbImages1.setPreferredSize(new Dimension(110,110));
        ...
        icon2 = new ImageIcon(getClass().getResource("/images_SanPham/DSMH062002.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon3 = new ImageIcon(getClass().getResource("/images_SanPham/DSMH062003.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon4 = new ImageIcon(getClass().getResource("/images_SanPham/HEM0007002.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
...
//                pnN11.setVisible(false);
        ...
        ImageIcon icon5 = new ImageIcon(getClass().getResource("/images_SanPham/giayballerina1.png"));
//        lbImages1.setPreferredSize(new Dimension(110,110));
        ...
        icon6 = new ImageIcon(getClass().getResource("/images_SanPham/giayballerina2.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon7 = new ImageIcon(getClass().getResource("/images_SanPham/giaypump1.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
        ...
        icon8 = new ImageIcon(getClass().getResource("/images_SanPham/giayvintas1.png"));
//        lbImages2.setPreferredSize(new Dimension(110,110));
